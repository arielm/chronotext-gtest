...
cmake -DCMAKE_TOOLCHAIN_FILE="$CMAKE_TOOLCHAIN_FILE" -DANDROID_NDK="$NDK_PATH" -DANDROID_ABI=$ANDROID_ABI -DANDROID_NATIVE_API_LEVEL=$ANDROID_PLATFORM -DCMAKE_BUILD_TYPE=Release -Dgtest_build_tests=OFF ..
