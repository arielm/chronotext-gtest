...
cmake -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DIOS_PLATFORM=${IOS_PLATFORM} -DIOS_MIN_VERSION=${IOS_MIN_VERSION} -DCMAKE_OSX_ARCHITECTURES=${ARCH1} -DCMAKE_BUILD_TYPE=Release ..
...
cmake -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DIOS_PLATFORM=${IOS_PLATFORM} -DIOS_MIN_VERSION=${IOS_MIN_VERSION} -DCMAKE_OSX_ARCHITECTURES=${ARCH2} -DCMAKE_BUILD_TYPE=Release ..
make -j$HOST_NUM_CPUS
